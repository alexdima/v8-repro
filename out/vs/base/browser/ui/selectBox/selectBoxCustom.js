 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/event", "vs/base/common/keyCodes", "vs/base/browser/keyboardEvent", "vs/base/browser/dom", "vs/base/common/arrays", "vs/base/browser/ui/list/listWidget", "vs/base/browser/event", "vs/base/common/scrollable", "vs/base/common/platform", "vs/css!./selectBoxCustom"], function (require, exports, nls, lifecycle_1, event_1, keyCodes_1, keyboardEvent_1, dom, arrays, listWidget_1, event_2, scrollable_1, platform_1) {
    "use strict";
    ...
    var SelectBoxList = /** @class */ (function () {
        ...
        SelectBoxList.prototype.createSelectList = function (parent) {
            ...
            var onSelectDropDownKeyDown = event_1.chain(event_2.domEvent(this.selectDropDownListContainer, 'keydown'))
            ...
            event_1.chain(event_2.domEvent(this.selectList.getHTMLElement(), 'mouseup'))
                .filter(function () { return _this.selectList.length > 0; })
