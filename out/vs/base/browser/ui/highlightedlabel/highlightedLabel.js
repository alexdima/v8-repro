define(["require", "exports", "vs/base/browser/dom", "vs/base/common/objects", "vs/base/browser/ui/octiconLabel/octiconLabel"], function (require, exports, dom, objects, octiconLabel_1) {
    /*---------------------------------------------------------------------------------------------
        ...
        HighlightedLabel.prototype.render = function () {
            ...
            for (var i = 0; i < this.highlights.length; i++) {
                ...
                if (pos < highlight.start) {
                    ...
                    htmlContent.push(octiconLabel_1.render(this.text.substring(pos, highlight.start)));
                    htmlContent.push('</span>');
                    pos = highlight.end;
                }
                htmlContent.push('<span class="highlight">');
                htmlContent.push(octiconLabel_1.render(this.text.substring(highlight.start, highlight.end)));
                htmlContent.push('</span>');
                pos = highlight.end;
            }
            if (pos < this.text.length) {
                htmlContent.push('<span>');
                htmlContent.push(octiconLabel_1.render(this.text.substring(pos)));
                htmlContent.push('</span>');
            }
