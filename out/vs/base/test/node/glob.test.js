define(["require", "exports", "assert", "path", "vs/base/common/glob", "vs/base/common/platform"], function (require, exports, assert, path, glob, platform_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Glob', function () {
        ...
        test('expression support (single)', function () {
            ...
            assert.strictEqual('**/*.js', glob.match(expression, 'test.js', function () { return siblings; }));
            assert.strictEqual(glob.match(expression, 'test.js', function () { return []; }), null);
            assert.strictEqual(glob.match(expression, 'test.js', function () { return ['te.ts']; }), null);
            ...
            assert.strictEqual(glob.match(expression, 'test.js', function () { return siblings; }), null);
            expression = {
                '**/*.js': {}
            };
            assert.strictEqual('**/*.js', glob.match(expression, 'test.js', function () { return siblings; }));
        ...
        test('expression support (multiple)', function () {
            ...
            assert.strictEqual('**/*.js', glob.match(expression, 'test.js', function () { return siblings; }));
            assert.strictEqual('**/*.as', glob.match(expression, 'test.as', function () { return siblings; }));
            assert.strictEqual('**/*.bananas', glob.match(expression, 'test.bananas', function () { return siblings; }));
            assert.strictEqual('**/*.bananas', glob.match(expression, 'test.bananas'));
            assert.strictEqual(glob.match(expression, 'test.foo', function () { return siblings; }), null);
        });
        ...
        test('expression with two basename globs and a siblings expression', function () {
            ...
            var sibilings = function () { return ['foo.ts', 'foo.js', 'foo', 'bar']; };
        ...
        test('expression/pattern basename', function () {
            ...
            var sibilings = function () { return ['foo.ts', 'foo.js']; };
        ...
        test('expression/pattern optimization for basenames', function () {
            ...
            var siblingsFn = function () { return ['baz', 'baz.zip', 'nope']; };
            testOptimizationForBasenames({
                '**/foo/**': { when: '$(basename).zip' },
                '**/bar/**': true
            }, ['bar'], [
        ...
        function testOptimizationForBasenames(pattern, basenameTerms, matches, siblingsFns) {
            if (siblingsFns === void 0) { siblingsFns = []; }
            var parsed = glob.parse(pattern, { trimForExclusions: true });
            assert.deepStrictEqual(glob.getBasenameTerms(parsed), basenameTerms);
            matches.forEach(function (_a, i) {
        ...
        test('relative pattern - glob star', function () {
            if (platform_1.isWindows) {
                var p = { base: 'C:\\DNXConsoleApp\\foo', pattern: '**/*.cs', pathToRelative: function (from, to) { return path.relative(from, to); } };
                assert(glob.match(p, 'C:\\DNXConsoleApp\\foo\\Program.cs'));
                ...
                var p = { base: '/DNXConsoleApp/foo', pattern: '**/*.cs', pathToRelative: function (from, to) { return path.relative(from, to); } };
                assert(glob.match(p, '/DNXConsoleApp/foo/Program.cs'));
        ...
        test('relative pattern - single star with path', function () {
            if (platform_1.isWindows) {
                var p = { base: 'C:\\DNXConsoleApp\\foo', pattern: 'something/*.cs', pathToRelative: function (from, to) { return path.relative(from, to); } };
                assert(glob.match(p, 'C:\\DNXConsoleApp\\foo\\something\\Program.cs'));
                assert(!glob.match(p, 'C:\\DNXConsoleApp\\foo\\Program.cs'));
            }
            else {
                var p = { base: '/DNXConsoleApp/foo', pattern: 'something/*.cs', pathToRelative: function (from, to) { return path.relative(from, to); } };
