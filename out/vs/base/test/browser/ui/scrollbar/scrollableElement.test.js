define(["require", "exports", "vs/base/browser/ui/scrollbar/scrollableElement", "assert"], function (require, exports, scrollableElement_1, assert) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('MouseWheelClassifier', function () {
        test('OSX - Apple Magic Mouse', function () {
            var testData = [
            ...
            var classifier = new scrollableElement_1.MouseWheelClassifier();
            for (var i = 0, len = testData.length; i < len; i++) {
                var _a = testData[i], timestamp = _a[0], deltaY = _a[1], deltaX = _a[2];
                classifier.accept(timestamp, deltaX, deltaY);
                var actual = classifier.isPhysicalMouseWheel();
                assert.equal(actual, false);
            }
        });
        test('OSX - Apple Touch Pad', function () {
            var testData = [
        ...
        test('OSX - Razer Physical Mouse Wheel', function () {
            var testData = [
                [1503409880776, -1, 0],
                [1503409880791, -1, 0],
                [1503409880810, -4, 0],
        ...
        test('Windows - Microsoft Arc Touch', function () {
            var testData = [
                [1503418316909, -2, 0],
                [1503418316985, -2, 0],
                [1503418316988, -4, 0],
        ...
        test('Windows - SurfaceBook TouchPad', function () {
            var testData = [
        ...
        test('Windows - Razer physical wheel', function () {
            var testData = [
                [1503418638271, -2, 0],
                [1503418638317, -2, 0],
                [1503418638336, -2, 0],
        ...
        test('Windows - Logitech physical wheel', function () {
            var testData = [
                [1503418872930, -2, 0],
                [1503418872952, -2, 0],
                [1503418872969, -2, 0],
        ...
        test('Windows - Microsoft basic v2 physical wheel', function () {
            var testData = [
                [1503418994564, -2, 0],
                [1503418994643, -2, 0],
                [1503418994676, -2, 0],
