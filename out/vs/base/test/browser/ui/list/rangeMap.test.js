 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/ui/list/rangeMap"], function (require, exports, assert, rangeMap_1) {
    "use strict";
    ...
    suite('RangeMap', function () {
        ...
        test('intersection', function () {
            assert.deepEqual(rangeMap_1.intersect({ start: 0, end: 0 }, { start: 0, end: 0 }), { start: 0, end: 0 });
            assert.deepEqual(rangeMap_1.intersect({ start: 0, end: 0 }, { start: 5, end: 5 }), { start: 0, end: 0 });
            assert.deepEqual(rangeMap_1.intersect({ start: 0, end: 1 }, { start: 5, end: 6 }), { start: 0, end: 0 });
            assert.deepEqual(rangeMap_1.intersect({ start: 5, end: 6 }, { start: 0, end: 1 }), { start: 0, end: 0 });
            assert.deepEqual(rangeMap_1.intersect({ start: 0, end: 5 }, { start: 2, end: 2 }), { start: 0, end: 0 });
