define(["require", "exports", "assert", "vs/base/common/strings"], function (require, exports, assert, strings) {
    ...
    suite('Strings', function () {
        ...
        test('compareIgnoreCase', function () {
            function assertCompareIgnoreCase(a, b, recurse) {
                if (recurse === void 0) { recurse = true; }
                var actual = strings.compareIgnoreCase(a, b);
                actual = actual > 0 ? 1 : actual < 0 ? -1 : actual;
                var expected = strings.compare(a.toLowerCase(), b.toLowerCase());
        ...
        test('lastNonWhitespaceIndex', function () {
        ...
        test('createRegExp', function () {
            // Empty
            assert.throws(function () { return strings.createRegExp('', false); });
        ...
        test('getLeadingWhitespace', function () {
        ...
        test('startsWithUTF8BOM', function () {
        ...
        test('containsUppercaseCharacter', function () {
            [
                [null, false],
                ['', false],
                ['foo', false],
                ...
                var str = _a[0], result = _a[1];
                assert.equal(strings.containsUppercaseCharacter(str), result, "Wrong result for " + str);
            });
        });
        test('containsUppercaseCharacter (ignoreEscapedChars)', function () {
            [
                ['\\Woo', false],
                ['f\\S\\S', false],
                ['foo', false],
                ...
                var str = _a[0], result = _a[1];
                assert.equal(strings.containsUppercaseCharacter(str, true), result, "Wrong result for " + str);
            });
        });
    });
});
