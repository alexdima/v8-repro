define(["require", "exports", "vs/base/common/uri", "vs/base/common/platform", "vs/base/common/paths", "vs/base/common/strings", "vs/base/common/network"], function (require, exports, uri_1, platform, paths_1, strings_1, network_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function getPathLabel(resource, rootProvider, userHomeProvider) {
        ...
        if (baseResource) {
            ...
            if (paths_1.isEqual(baseResource.uri.fsPath, resource.fsPath, !platform.isLinux /* ignorecase */)) {
