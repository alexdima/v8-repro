 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/comparers", "vs/base/common/filters", "vs/base/common/paths", "vs/base/common/platform", "vs/base/common/strings"], function (require, exports, comparers_1, filters_1, paths_1, platform_1, strings_1) {
    'use strict';
    ...
    function prepareQuery(value) {
        ...
        if (value) {
            value = strings_1.stripWildcards(value).replace(/\s/g, ''); // get rid of all wildcards and whitespace
        ...
        return { value: value, lowercase: lowercase, containsPathSeparator: containsPathSeparator };
    }
    ...
    function doScoreItem(label, description, path, query, fuzzy) {
        ...
        if (path && paths_1.isEqual(query.value, path, true)) {
