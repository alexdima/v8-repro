...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/base/common/platform", "vs/base/common/types", "vs/base/common/errors", "vs/base/parts/quickopen/common/quickOpen", "vs/base/parts/quickopen/browser/quickOpenViewer", "vs/base/browser/builder", "vs/base/browser/ui/inputbox/inputBox", "vs/base/common/severity", "vs/base/parts/tree/browser/treeImpl", "vs/base/browser/ui/progressbar/progressbar", "vs/base/browser/keyboardEvent", "vs/base/parts/tree/browser/treeDefaults", "vs/base/browser/dom", "vs/base/common/lifecycle", "vs/base/common/scrollable", "vs/base/common/color", "vs/base/common/objects", "vs/base/browser/mouseEvent", "vs/css!./quickopen"], function (require, exports, nls, winjs_base_1, platform, types, errors, quickOpen_1, quickOpenViewer_1, builder_1, inputBox_1, severity_1, treeImpl_1, progressbar_1, keyboardEvent_1, treeDefaults_1, DOM, lifecycle_1, scrollable_1, color_1, objects_1, mouseEvent_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var QuickOpenWidget = /** @class */ (function () {
        ...
        QuickOpenWidget.prototype.create = function () {
            ...
            this.builder = builder_1.$().div(function (div) {
                ...
                // Progress Bar
                _this.progressBar = new progressbar_1.ProgressBar(div.clone(), { progressBarBackground: _this.styles.progressBarBackground });
                ...
                _this.treeContainer = div.div({
                    ...
                    var createTree = _this.options.treeCreator || (function (container, config, opts) { return new treeImpl_1.Tree(container, config, opts); });
                    _this.tree = createTree(div.getHTMLElement(), {
                        dataSource: new quickOpenViewer_1.DataSource(_this),
                        controller: new QuickOpenController({ clickBehavior: treeDefaults_1.ClickBehavior.ON_MOUSE_UP, keyboardSupport: _this.options.keyboardSupport }),
                        renderer: (_this.renderer = new quickOpenViewer_1.Renderer(_this, _this.styles)),
                    ...
                    _this.toUnbind.push(_this.tree.onDidChangeSelection(function (event) {
                        if (event.selection && event.selection.length > 0) {
                            var mouseEvent = event.payload && event.payload.originalEvent instanceof mouseEvent_1.StandardMouseEvent ? event.payload.originalEvent : void 0;
