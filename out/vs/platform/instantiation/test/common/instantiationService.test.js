...
define(["require", "exports", "assert", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/instantiationService", "vs/platform/instantiation/common/serviceCollection", "vs/platform/instantiation/common/descriptors"], function (require, exports, assert, instantiation_1, instantiationService_1, serviceCollection_1, descriptors_1) {
    ...
    var Service1Consumer = /** @class */ (function () {
        function Service1Consumer(service1) {
            assert.ok(service1);
        ...
        return Service1Consumer;
    }());
    var Target2Dep = /** @class */ (function () {
    ...
    var TargetWithStaticParam = /** @class */ (function () {
    ...
    var TargetNotOptional = /** @class */ (function () {
    ...
    var TargetOptional = /** @class */ (function () {
    ...
    var DependentServiceTarget = /** @class */ (function () {
    ...
    var DependentServiceTarget2 = /** @class */ (function () {
    ...
    var ServiceLoop1 = /** @class */ (function () {
    ...
    var ServiceLoop2 = /** @class */ (function () {
    ...
    suite('Instantiation Service', function () {
        ...
        test('Invoke - get service, optional', function () {
            ...
            function test(accessor) {
                assert.ok(accessor.get(IService1) instanceof Service1);
                assert.throws(function () { return accessor.get(IService2); });
        ...
        test('Create child', function () {
            var serviceInstanceCount = 0;
            var CtorCounter = /** @class */ (function () {
                function class_1() {
                    this.c = 1;
            ...
            var service = new instantiationService_1.InstantiationService(new serviceCollection_1.ServiceCollection([IService1, new descriptors_1.SyncDescriptor(CtorCounter)]));
            service.createInstance(Service1Consumer);
            // second instance must be earlier ONE
            var child = service.createChild(new serviceCollection_1.ServiceCollection([IService2, new Service2()]));
