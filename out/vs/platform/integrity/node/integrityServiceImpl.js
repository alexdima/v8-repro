...
define(["require", "exports", "vs/nls", "fs", "crypto", "vs/base/common/winjs.base", "vs/platform/message/common/message", "vs/platform/node/product", "vs/base/common/uri", "vs/base/common/severity", "vs/base/common/actions", "vs/platform/storage/common/storage", "vs/platform/lifecycle/common/lifecycle"], function (require, exports, nls, fs, crypto, winjs_base_1, message_1, product_1, uri_1, severity_1, actions_1, storage_1, lifecycle_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var IntegrityServiceImpl = /** @class */ (function () {
        function IntegrityServiceImpl(messageService, storageService, lifecycleService) {
            var _this = this;
