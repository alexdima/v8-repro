...
define(["require", "exports", "vs/base/common/arrays", "vs/base/common/event", "vs/base/browser/mouseEvent", "vs/base/common/types", "vs/base/browser/builder", "vs/base/browser/ui/sash/sash", "vs/base/browser/ui/progressbar/progressbar", "vs/base/browser/dom", "vs/base/common/errors", "vs/base/common/async", "vs/base/common/platform", "vs/workbench/services/editor/common/editorService", "vs/platform/editor/common/editor", "vs/workbench/services/group/common/groupService", "vs/platform/instantiation/common/instantiation", "vs/platform/instantiation/common/serviceCollection", "vs/platform/contextkey/common/contextkey", "vs/platform/extensions/common/extensions", "vs/workbench/browser/parts/editor/tabsTitleControl", "vs/workbench/browser/parts/editor/noTabsTitleControl", "vs/workbench/common/editor", "vs/editor/browser/services/codeEditorService", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/workbench/common/theme", "vs/platform/theme/common/styler", "vs/base/common/lifecycle", "vs/workbench/browser/dnd", "vs/platform/telemetry/common/telemetry", "vs/css!./media/editorGroupsControl"], function (require, exports, arrays, event_1, mouseEvent_1, types, builder_1, sash_1, progressbar_1, DOM, errors, async_1, platform_1, editorService_1, editor_1, groupService_1, instantiation_1, serviceCollection_1, contextkey_1, extensions_1, tabsTitleControl_1, noTabsTitleControl_1, editor_2, codeEditorService_1, themeService_1, colorRegistry_1, theme_1, styler_1, lifecycle_1, dnd_1, telemetry_1) {
    'use strict';
     ...
     */
    var EditorGroupsControl = /** @class */ (function (_super) {
        __extends(EditorGroupsControl, _super);
        function EditorGroupsControl(parent, groupOrientation, editorService, editorGroupService, contextKeyService, extensionService, instantiationService, themeService, telemetryService) {
            ...
            _this.visibleEditorFocusTrackerDisposable = [];
        ...
        EditorGroupsControl.prototype.registerListeners = function () {
            ...
            this.toUnbind.push(this.extensionService.onDidRegisterExtensions(function () { return _this.onDidRegisterExtensions(); }));
        };
        EditorGroupsControl.prototype.updateTabOptions = function (tabOptions, refresh) {
            ...
            var tabSizing = this.tabOptions ? this.tabOptions.tabSizing : 'fit';
            var iconTheme = this.tabOptions ? this.tabOptions.iconTheme : 'vs-seti';
            ...
            editor_1.POSITIONS.forEach(function (position) {
                ...
                if (titleControl) {
                    ...
                    else if (showingIcons !== _this.tabOptions.showIcons ||
                        tabCloseButton !== _this.tabOptions.tabCloseButton ||
                        tabSizing !== _this.tabOptions.tabSizing ||
                        iconTheme !== _this.tabOptions.iconTheme) {
        ...
        EditorGroupsControl.prototype.onDidRegisterExtensions = function () {
            var _this = this;
        ...
        EditorGroupsControl.prototype.trackFocus = function (editor, position) {
            ...
            var focusTracker = DOM.trackFocus(editor.getFocusContainer().getHTMLElement());
            var listenerDispose = focusTracker.onDidFocus(function () {
                _this.onFocusGained(editor);
            });
            this.visibleEditorFocusTrackerDisposable[position] = lifecycle_1.combinedDisposable([focusTracker, listenerDispose]);
        };
        ...
        EditorGroupsControl.prototype.rochade = function (from, to) {
            ...
            var listeners = this.visibleEditorFocusTrackerDisposable[from];
        ...
        EditorGroupsControl.prototype.create = function () {
            ...
            this.toUnbind.push(this.sashOne.onDidStart(function () { return _this.onSashOneDragStart(); }));
            this.toUnbind.push(this.sashOne.onDidChange(function (e) { return _this.onSashOneDrag(e); }));
            this.toUnbind.push(this.sashOne.onDidEnd(function () { return _this.onSashOneDragEnd(); }));
            this.toUnbind.push(this.sashOne.onDidReset(function () { return _this.onSashOneReset(); }));
            this.sashOne.hide();
            // Silo Two
            ...
            this.toUnbind.push(this.sashTwo.onDidStart(function () { return _this.onSashTwoDragStart(); }));
            this.toUnbind.push(this.sashTwo.onDidChange(function (e) { return _this.onSashTwoDrag(e); }));
            this.toUnbind.push(this.sashTwo.onDidEnd(function () { return _this.onSashTwoDragEnd(); }));
            this.toUnbind.push(this.sashTwo.onDidReset(function () { return _this.onSashTwoReset(); }));
            this.sashTwo.hide();
            // Silo Three
        ...
        EditorGroupsControl.prototype.enableDropTarget = function (node) {
            ...
            function onDrop(e, position, splitTo) {
                ...
                if ($this.transfer.hasData(dnd_1.DraggedEditorIdentifier.prototype)) {
                    var draggedEditor_1 = $this.transfer.getData(dnd_1.DraggedEditorIdentifier.prototype)[0].identifier;
                    var isCopy = (e.ctrlKey && !platform_1.isMacintosh) || (e.altKey && platform_1.isMacintosh);
                    // Copy editor to new location
                    if (isCopy) {
                        if (splitEditor) {
                            editorService.openEditor(draggedEditor_1.editor, optionsFromDraggedEditor(draggedEditor_1), freeGroup).then(function () {
                            ...
                            editorService.openEditor(draggedEditor_1.editor, optionsFromDraggedEditor(draggedEditor_1), position).done(null, errors.onUnexpectedError);
                        }
                    }
                    else {
                        var sourcePosition = stacks.positionOfGroup(draggedEditor_1.group);
                        if (splitEditor) {
                            if (draggedEditor_1.group.count === 1) {
                                ...
                                editorService.openEditor(draggedEditor_1.editor, optionsFromDraggedEditor(draggedEditor_1), freeGroup).then(function () {
                                    ...
                                    groupService.moveEditor(draggedEditor_1.editor, stacks.positionOfGroup(draggedEditor_1.group), splitTo);
                                }).done(null, errors.onUnexpectedError);
                            }
                        }
                        else {
                            groupService.moveEditor(draggedEditor_1.editor, sourcePosition, position);
                        }
                    }
                }
                else {
                    ...
                    dropHandler.handleDrop(e, function () {
            ...
            this.toUnbind.push(DOM.addDisposableListener(node, DOM.EventType.DROP, function (e) {
                if (e.target === node || DOM.isAncestor(e.target, node)) {
                    ...
                    _this.updateFromDragAndDrop(node, false);
                }
            }));
            // Drag enter
            ...
            this.toUnbind.push(DOM.addDisposableListener(node, DOM.EventType.DRAG_ENTER, function (e) {
                ...
                counter++;
                _this.updateFromDragAndDrop(node, true);
                var target = e.target;
                if (target) {
                    ...
                    if (overlay) {
                        _this.updateFromDragAndDrop(node, false); // if we show an overlay, we can remove the drop feedback from the editor background
                    }
                }
            }));
            // Drag leave
            ...
            titleContainer.on(DOM.EventType.MOUSE_DOWN, function (e) {
                ...
                $window.on(DOM.EventType.MOUSE_MOVE, function (e) {
                    ...
                    if (moveTo !== null) {
                        ...
                        */
                        _this.telemetryService.publicLog('editorGroupMoved', { source: position, to: moveTo });
        ...
        EditorGroupsControl.prototype.updateFromDragAndDrop = function (element, isDraggedOver) {
            var groupCount = this.stacks.groups.length;
            var background = this.getColor(isDraggedOver ? theme_1.EDITOR_DRAG_AND_DROP_BACKGROUND : groupCount > 0 ? theme_1.EDITOR_GROUP_BACKGROUND : null);
        ...
        EditorGroupsControl.prototype.layoutContainers = function () {
            ...
            editor_1.POSITIONS.forEach(function (position) {
                var siloWidth = _this.layoutVertically ? _this.silosSize[position] : _this.dimension.width;
                _this.getTitleAreaControl(position).layout(new builder_1.Dimension(siloWidth, EditorGroupsControl.EDITOR_TITLE_HEIGHT));
            });
        ...
        EditorGroupsControl.prototype.updateTitleAreas = function (refreshActive) {
            var _this = this;
            editor_1.POSITIONS.forEach(function (position) {
                var group = _this.stacks.groupAt(position);
                if (!group) {
                    return;
                }
                var titleControl = _this.getTitleAreaControl(position);
