 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/platform", "vs/platform/files/common/files", "vs/base/common/uri", "vs/workbench/services/files/node/watcher/common", "vs/base/common/event"], function (require, exports, assert, platform, files_1, uri_1, common_1, event_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    var TestFileWatcher = /** @class */ (function () {
        function TestFileWatcher() {
            this._onFileChanges = new event_1.Emitter();
        }
        Object.defineProperty(TestFileWatcher.prototype, "onFileChanges", {
            get: function () {
    ...
    suite('Watcher', function () {
        test('watching - simple add/update/delete', function (done) {
            ...
            watch.onFileChanges(function (e) {
                assert.ok(e);
