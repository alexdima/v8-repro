...
define(["require", "exports", "vs/base/common/winjs.base", "vs/base/common/arrays", "vs/base/common/strings", "vs/platform/registry/common/platform", "vs/platform/configuration/common/configurationRegistry", "vs/base/common/filters", "vs/workbench/services/configuration/common/configuration", "vs/platform/environment/common/environment", "vs/platform/instantiation/common/instantiation", "vs/platform/request/node/request", "vs/base/node/request", "vs/base/common/lifecycle", "vs/platform/extensionManagement/common/extensionManagement", "vs/platform/log/common/log"], function (require, exports, winjs_base_1, arrays_1, strings, platform_1, configurationRegistry_1, filters_1, configuration_1, environment_1, instantiation_1, request_1, request_2, lifecycle_1, extensionManagement_1, log_1) {
    "use strict";
    ...
    var PreferencesSearchService = /** @class */ (function (_super) {
        ...
        function PreferencesSearchService(configurationService, environmentService, instantiationService, extensionManagementService, extensionEnablementService) {
            ...
            _this._installedExtensions = _this.extensionManagementService.getInstalled(extensionManagement_1.LocalExtensionType.User).then(function (exts) {
                // Filter to enabled extensions that have settings
                return exts
                    .filter(function (ext) { return _this.extensionEnablementService.isEnabled(ext.identifier); })
    ...
    var LocalSearchProvider = /** @class */ (function () {
        ...
        LocalSearchProvider.prototype.searchModel = function (preferencesModel) {
            var _this = this;
            if (!this._filter) {
                return winjs_base_1.TPromise.wrap(null);
            }
            var score = 1000; // Sort is not stable
        ...
        LocalSearchProvider.prototype.getGroupFilter = function (filter) {
            var regex = strings.createRegExp(this._filter, false, { global: true });
    ...
    var RemoteSearchProvider = /** @class */ (function () {
        ...
        RemoteSearchProvider.prototype.searchModel = function (preferencesModel) {
            var _this = this;
            return this._remoteSearchP.then(function (remoteResult) {
                ...
                if (_this.options.newExtensionsOnly) {
                    var passingScoreKeys = resultKeys.filter(function (k) { return remoteResult.scoredResults[k].score >= minScore; });
