 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/workbench/parts/snippets/electron-browser/snippetsService", "vs/editor/common/core/position"], function (require, exports, assert, snippetsService_1, position_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('getNonWhitespacePrefix', function () {
        function assertGetNonWhitespacePrefix(line, column, expected) {
            var model = {
                getLineContent: function (lineNumber) { return line; }
            };
            var actual = snippetsService_1.getNonWhitespacePrefix(model, new position_1.Position(1, column));
            assert.equal(actual, expected);
        }
        test('empty line', function () {
            assertGetNonWhitespacePrefix('', 1, '');
        });
        test('singleWordLine', function () {
