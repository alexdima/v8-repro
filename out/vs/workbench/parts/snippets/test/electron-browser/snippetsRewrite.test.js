...
define(["require", "exports", "assert", "vs/workbench/parts/snippets/electron-browser/snippetsFile"], function (require, exports, assert, snippetsFile_1) {
    ...
    suite('SnippetRewrite', function () {
        function assertRewrite(input, expected) {
            var actual = snippetsFile_1.Snippet._rewriteBogousVariables(input);
        ...
        test('lazy bogous variable rewrite', function () {
            var snippet = new snippetsFile_1.Snippet(['fooLang'], 'foo', 'prefix', 'desc', 'This is ${bogous} because it is a ${var}', 'source');
