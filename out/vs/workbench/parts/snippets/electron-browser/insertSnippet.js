...
define(["require", "exports", "vs/nls", "vs/base/common/winjs.base", "vs/editor/browser/editorExtensions", "vs/platform/quickOpen/common/quickOpen", "vs/editor/common/services/modeService", "vs/platform/commands/common/commands", "vs/workbench/parts/snippets/electron-browser/snippets.contribution", "vs/editor/contrib/snippet/snippetController2", "vs/editor/common/editorContextKeys", "vs/workbench/parts/snippets/electron-browser/snippetsFile"], function (require, exports, nls, winjs_base_1, editorExtensions_1, quickOpen_1, modeService_1, commands_1, snippets_contribution_1, snippetController2_1, editorContextKeys_1, snippetsFile_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var InsertSnippetAction = /** @class */ (function (_super) {
        ...
        InsertSnippetAction.prototype.run = function (accessor, editor, arg) {
            ...
            return new winjs_base_1.TPromise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var languageId, language, snippets, picks, prevSnippet, _i, snippets_1, snippet_1, pick;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (snippet) {
                                return [2 /*return*/, resolve(new snippetsFile_1.Snippet(undefined, undefined, undefined, undefined, snippet, undefined))];
                            }
                            if (langId) {
                        ...
                        case 3:
                            ...
                            for (_i = 0, snippets_1 = snippets; _i < snippets_1.length; _i++) {
                                ...
                                if (!snippet_1.isFromExtension && !prevSnippet) {
                                    pick.separator = { label: nls.localize('sep.userSnippet', "User Snippets") };
                                }
                                else if (snippet_1.isFromExtension && (!prevSnippet || !prevSnippet.isFromExtension)) {
                                    pick.separator = { label: nls.localize('sep.extSnippet', "Extension Snippets") };
                                }
                                picks.push(pick);
                                prevSnippet = snippet_1;
                            }
                            return [2 /*return*/, quickOpenService.pick(picks, { matchOnDetail: true }).then(function (pick) { return resolve(pick && pick.snippet); }, reject)];
