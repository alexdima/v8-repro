...
define(["require", "exports", "vs/nls", "vs/base/common/arrays", "vs/base/common/objects", "vs/base/common/collections", "vs/base/common/strings", "vs/base/common/glob", "vs/base/common/paths", "vs/base/common/uri", "vs/base/common/labels", "vs/platform/workspace/common/workspace", "vs/platform/search/common/search", "vs/platform/configuration/common/configuration", "vs/platform/environment/common/environment"], function (require, exports, nls, arrays, objects, collections, strings, glob, paths, uri_1, labels_1, workspace_1, search_1, configuration_1, environment_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var QueryBuilder = /** @class */ (function () {
        ...
        QueryBuilder.prototype.query = function (type, contentPattern, folderResources, options) {
            ...
            var folderQueries = folderResources && folderResources.map(function (uri) { return _this.getFolderQueryForRoot(uri, type === search_1.QueryType.File, options); });
        ...
        QueryBuilder.prototype.expandAbsoluteSearchPaths = function (searchPath) {
            if (paths.isAbsolute(searchPath)) {
                ...
                return [uri_1.default.file(paths.normalize(searchPath))];
            }
            if (this.workspaceContextService.getWorkbenchState() === workspace_1.WorkbenchState.FOLDER) {
                ...
                if (relativeSearchPathMatch_1) {
                    ...
                    var matchingRoots = this.workspaceContextService.getWorkspace().folders.filter(function (folder) { return paths.basename(folder.uri.fsPath) === searchPathRoot_1; });
                    if (matchingRoots.length) {
                        return matchingRoots.map(function (root) {
                            return relativeSearchPathMatch_1[2] ?
                                root.uri.with({ path: paths.normalize(paths.join(root.uri.path, relativeSearchPathMatch_1[2])) }) :
                                root.uri;
                        });
                    }
                    else {
