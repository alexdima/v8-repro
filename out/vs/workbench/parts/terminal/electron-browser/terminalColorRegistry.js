 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/nls", "vs/platform/theme/common/colorRegistry"], function (require, exports, nls, colorRegistry_1) {
    "use strict";
    ...
    exports.TERMINAL_BORDER_COLOR = colorRegistry_1.registerColor('terminal.border', null, nls.localize('terminal.border', 'The color of the border that separates multiple terminals. This defaults to panel.border'));
    var ansiColorMap = {
        'terminal.ansiBlack': {
            index: 0,
            defaults: {
