...
define(["require", "exports", "vs/base/common/event", "vs/workbench/common/editor", "vs/platform/storage/common/storage", "vs/platform/instantiation/common/instantiation", "vs/platform/configuration/common/configuration", "vs/platform/lifecycle/common/lifecycle", "vs/base/common/lifecycle", "vs/platform/registry/common/platform", "vs/platform/editor/common/editor", "vs/base/common/map"], function (require, exports, event_1, editor_1, storage_1, instantiation_1, configuration_1, lifecycle_1, lifecycle_2, platform_1, editor_2, map_1) {
    ...
    var EditorGroup = /** @class */ (function () {
        ...
        EditorGroup.prototype.registerListeners = function () {
            var _this = this;
            this.toDispose.push(this.configurationService.onDidChangeConfiguration(function (e) { return _this.onConfigurationUpdated(e); }));
        };
        EditorGroup.prototype.onConfigurationUpdated = function (event) {
            this.editorOpenPositioning = this.configurationService.getValue(editor_1.OPEN_POSITIONING_CONFIG);
        };
        ...
        EditorGroup.prototype.doCloseEditor = function (editor, openNext, replaced) {
            ...
            // Event
            return { editor: editor, replaced: replaced, index: index, group: this };
        };
    ...
    var EditorStacksModel = /** @class */ (function () {
        ...
        EditorStacksModel.prototype.last = function () {
            this.ensureLoaded();
            if (!this.activeGroup) {
                return null;
            }
