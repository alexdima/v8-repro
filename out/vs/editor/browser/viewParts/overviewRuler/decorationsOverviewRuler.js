...
define(["require", "exports", "vs/editor/browser/view/viewPart", "vs/editor/common/core/position", "vs/editor/common/modes", "vs/editor/common/view/editorColorRegistry", "vs/base/common/color", "vs/base/browser/fastDomNode"], function (require, exports, viewPart_1, position_1, modes_1, editorColorRegistry_1, color_1, fastDomNode_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var Settings = /** @class */ (function () {
        function Settings(config, theme) {
            ...
            this.backgroundColor = (backgroundColor ? color_1.Color.Format.CSS.formatHex(backgroundColor) : null);
