...
define(["require", "exports", "vs/editor/browser/view/viewPart", "vs/editor/common/view/runtimeMinimapCharRenderer", "vs/base/browser/dom", "vs/editor/common/view/minimapCharRenderer", "vs/editor/common/editorCommon", "vs/base/browser/fastDomNode", "vs/editor/browser/view/viewLayer", "vs/editor/common/core/range", "vs/editor/common/view/viewEvents", "vs/base/browser/globalMouseMoveMonitor", "vs/base/common/platform", "vs/platform/theme/common/themeService", "vs/platform/theme/common/colorRegistry", "vs/css!./minimap"], function (require, exports, viewPart_1, runtimeMinimapCharRenderer_1, dom, minimapCharRenderer_1, editorCommon, fastDomNode_1, viewLayer_1, range_1, viewEvents, globalMouseMoveMonitor_1, platform, themeService_1, colorRegistry_1) {
    'use strict';
    ...
    var Minimap = /** @class */ (function (_super) {
        ...
        function Minimap(context) {
            ...
            viewPart_1.PartFingerprints.write(_this._domNode, 8 /* Minimap */);
            ...
            _this._mouseDownListener = dom.addStandardDisposableListener(_this._canvas.domNode, 'mousedown', function (e) {
                ...
                _this._context.privateViewEventBus.emit(new viewEvents.ViewRevealRangeRequestEvent(new range_1.Range(lineNumber, 1, lineNumber, 1), 1 /* Center */, false, 0 /* Smooth */));
            });
