define(["require", "exports", "vs/editor/common/core/position", "vs/editor/common/editorCommon", "vs/editor/browser/controller/coreCommands"], function (require, exports, position_1, editorCommon, coreCommands_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var ViewController = /** @class */ (function () {
        ...
        ViewController.prototype.setSelection = function (source, modelSelection) {
            this._execCoreEditorCommandFunc(coreCommands_1.CoreNavigationCommands.SetSelection, {
                source: source,
