        ...
        function TextAreaHandler(context, viewController, viewHelper) {
            ...
            var textAreaInputHost = {
                ...
                getScreenReaderContent: function (currentState) {
                            ...
                            if (selection.isEmpty()) {
                                ...
                                if (position.column > 1) {
                                    ...
                                    if (!strings.isHighSurrogate(charBefore.charCodeAt(0))) {
                                        return new textAreaState_1.TextAreaState(charBefore, 1, 1, position, position);
                                    }
                                }
                            }
                        }
                    ...
                    return textAreaState_1.PagedScreenReaderStrategy.fromEditorSelection(currentState, simpleModel, _this._selections[0], _this._accessibilitySupport === 0 /* Unknown */);
                },
            ...
            _this._register(_this._textAreaInput.onCompositionStart(function () {
                ...
                _this._context.privateViewEventBus.emit(new viewEvents.ViewRevealRangeRequestEvent(new range_1.Range(lineNumber, column, lineNumber, column), 0 /* Simple */, true, 1 /* Immediate */));
