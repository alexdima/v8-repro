...
define(["require", "exports", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/editorCommon", "vs/editor/common/controller/cursorCommon", "vs/editor/common/controller/cursorEvents", "vs/editor/common/controller/cursorMoveCommands", "vs/editor/browser/editorExtensions", "vs/editor/common/controller/cursorColumnSelection", "vs/editor/common/editorContextKeys", "vs/platform/keybinding/common/keybindingsRegistry", "vs/editor/browser/services/codeEditorService", "vs/platform/contextkey/common/contextkey", "vs/base/common/types", "vs/platform/editor/common/editor", "vs/editor/common/controller/cursorTypeOperations", "vs/editor/common/controller/cursorDeleteOperations"], function (require, exports, position_1, range_1, editorCommon, cursorCommon_1, cursorEvents_1, cursorMoveCommands_1, editorExtensions_1, cursorColumnSelection_1, editorContextKeys_1, keybindingsRegistry_1, codeEditorService_1, contextkey_1, types, editor_1, cursorTypeOperations_1, cursorDeleteOperations_1) {
    'use strict';
    ...
    (function (CoreEditingCommands) {
        ...
        CoreEditingCommands.DeleteLeft = editorExtensions_1.registerEditorCommand(new /** @class */ (function (_super) {
            ...
            class_22.prototype.runEditorCommand = function (accessor, editor, args) {
                var cursors = editor._getCursors();
                var _a = cursorDeleteOperations_1.DeleteOperations.deleteLeft(cursors.getPrevEditOperationType(), editor._getCursorConfiguration(), editor.getModel(), editor.getSelections()), shouldPushStackElementBefore = _a[0], commands = _a[1];
        ...
        CoreEditingCommands.DeleteRight = editorExtensions_1.registerEditorCommand(new /** @class */ (function (_super) {
            ...
            class_23.prototype.runEditorCommand = function (accessor, editor, args) {
                var cursors = editor._getCursors();
                var _a = cursorDeleteOperations_1.DeleteOperations.deleteRight(cursors.getPrevEditOperationType(), editor._getCursorConfiguration(), editor.getModel(), editor.getSelections()), shouldPushStackElementBefore = _a[0], commands = _a[1];
                if (shouldPushStackElementBefore) {
                    editor.pushUndoStop();
                }
                editor.executeCommands(this.id, commands);
