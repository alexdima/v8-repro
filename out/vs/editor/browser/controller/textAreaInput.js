...
define(["require", "exports", "vs/base/common/async", "vs/editor/common/core/selection", "vs/base/common/strings", "vs/base/common/event", "vs/base/common/lifecycle", "vs/editor/browser/controller/textAreaState", "vs/base/browser/browser", "vs/base/common/platform", "vs/base/browser/dom"], function (require, exports, async_1, selection_1, strings, event_1, lifecycle_1, textAreaState_1, browser, platform, dom) {
    /*---------------------------------------------------------------------------------------------
    ...
    var TextAreaInput = /** @class */ (function (_super) {
        ...
        TextAreaInput.prototype._ensureClipboardGetsEditorSelection = function (e) {
            ...
            var copyHTML = null;
            if (!browser.isEdgeOrIE && (copyPlainText.length < 65536 || exports.CopyOptions.forceCopyWithSyntaxHighlighting)) {
