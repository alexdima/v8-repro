...
define(["require", "exports", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/browser/editorBrowser", "vs/editor/browser/editorDom", "vs/base/browser/browser", "vs/editor/browser/view/viewPart", "vs/editor/browser/viewParts/lines/viewLine"], function (require, exports, position_1, range_1, editorBrowser_1, editorDom_1, browser, viewPart_1, viewLine_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var HitTestContext = /** @class */ (function () {
        ...
        HitTestContext.prototype.getZoneAtCoord = function (mouseVerticalOffset) {
            ...
            var viewZoneWhitespace = this._context.viewLayout.getWhitespaceAtVerticalOffset(mouseVerticalOffset);
    ...
    var EMPTY_CONTENT_IN_LINES = { isAfterLines: false };
    var MouseTargetFactory = /** @class */ (function () {
        ...
        MouseTargetFactory._hitTestViewLines = function (ctx, request, domHitTestExecuted) {
            ...
            if (ctx.isAfterLines(request.mouseVerticalOffset)) {
                ...
                return request.fulfill(editorBrowser_1.MouseTargetType.CONTENT_EMPTY, new position_1.Position(lineCount, maxLineColumn), void 0, EMPTY_CONTENT_AFTER_LINES);
            }
            if (domHitTestExecuted) {
        ...
        MouseTargetFactory.createMouseTargetFromHitTestPosition = function (ctx, request, lineNumber, column) {
            ...
            if (request.mouseContentHorizontalOffset > lineWidth) {
                if (browser.isEdge && pos.column === 1) {
                    ...
                    return request.fulfill(editorBrowser_1.MouseTargetType.CONTENT_EMPTY, new position_1.Position(lineNumber, ctx.model.getLineMaxColumn(lineNumber)), void 0, EMPTY_CONTENT_IN_LINES);
                }
                return request.fulfill(editorBrowser_1.MouseTargetType.CONTENT_EMPTY, pos, void 0, EMPTY_CONTENT_IN_LINES);
            }
