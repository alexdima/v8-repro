...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/winjs.base", "vs/base/browser/dom", "vs/platform/instantiation/common/instantiation", "vs/platform/commands/common/commands", "vs/platform/contextkey/common/contextkey", "vs/editor/common/commonCodeEditor", "vs/editor/browser/editorExtensions", "vs/editor/browser/services/codeEditorService", "vs/editor/browser/config/configuration", "vs/editor/browser/view/viewImpl", "vs/base/common/lifecycle", "vs/base/common/event", "vs/editor/common/editorAction", "vs/platform/theme/common/themeService", "vs/editor/common/view/editorColorRegistry", "vs/editor/common/model/intervalTree", "vs/css!./media/editor", "vs/css!./media/tokens"], function (require, exports, errors_1, winjs_base_1, dom, instantiation_1, commands_1, contextkey_1, commonCodeEditor_1, editorExtensions_1, codeEditorService_1, configuration_1, viewImpl_1, lifecycle_1, event_1, editorAction_1, themeService_1, editorColorRegistry_1, intervalTree_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    themeService_1.registerThemingParticipant(function (theme, collector) {
        ...
        if (errorForeground) {
            collector.addRule(".monaco-editor ." + intervalTree_1.ClassName.EditorErrorDecoration + " { background: url(\"data:image/svg+xml;utf8," + getSquigglySVGData(errorForeground) + "\") repeat-x bottom left; }");
        }
        ...
        if (warningForeground) {
            collector.addRule(".monaco-editor ." + intervalTree_1.ClassName.EditorWarningDecoration + " { background: url(\"data:image/svg+xml;utf8," + getSquigglySVGData(warningForeground) + "\") repeat-x bottom left; }");
        }
        ...
        if (infoForeground) {
            collector.addRule(".monaco-editor ." + intervalTree_1.ClassName.EditorInfoDecoration + " { background: url(\"data:image/svg+xml;utf8," + getSquigglySVGData(infoForeground) + "\") repeat-x bottom left; }");
        }
    });
});
