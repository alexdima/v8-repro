...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/base/common/winjs.base", "vs/editor/common/services/resolverService", "vs/platform/files/common/files", "vs/editor/common/core/editOperation", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/platform/progress/common/progress", "vs/platform/instantiation/common/instantiation", "vs/editor/common/modes", "vs/base/common/labels"], function (require, exports, nls, lifecycle_1, uri_1, winjs_base_1, resolverService_1, files_1, editOperation_1, range_1, selection_1, progress_1, instantiation_1, modes_1, labels_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var IRecording = /** @class */ (function () {
        ...
        IRecording.start = function (fileService) {
            ...
            return {
                stop: function () { return lifecycle_1.dispose(stop); },
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            this._edits.forEach(function (value, key) {
                                var promise = _this._textModelResolverService.createModelReference(uri_1.default.parse(key)).then(function (ref) {
                            ...
                            return [4 /*yield*/, winjs_base_1.TPromise.join(promises)];
                        case 1:
                            _a.sent();
    ...
    var BulkEdit = /** @class */ (function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            conflicts = edits
                                ...
                                .map(function (edit) { return labels_1.getPathLabel(edit.resource); });
                            recording.stop();
        ...
        BulkEdit = __decorate([
            ...
            __param(3, instantiation_1.optional(files_1.IFileService))
        ], BulkEdit);
        return BulkEdit;
    }());
