...
define(["require", "exports", "vs/base/common/strings", "vs/base/common/uri", "vs/base/browser/dom", "vs/editor/common/editorCommon", "vs/editor/common/model", "vs/editor/browser/services/abstractCodeEditorService", "vs/base/common/lifecycle", "vs/platform/theme/common/themeService"], function (require, exports, strings, uri_1, dom, editorCommon_1, model_1, abstractCodeEditorService_1, lifecycle_1, themeService_1) {
    /*---------------------------------------------------------------------------------------------
            ...
            if (typeof opts !== 'undefined') {
                ...
                if (typeof opts.contentIconPath !== 'undefined') {
                    if (typeof opts.contentIconPath === 'string') {
                        cssTextArr.push(strings.format(_CSS_MAP.contentIconPath, uri_1.default.file(opts.contentIconPath).toString().replace(/'/g, '%27')));
                    }
                    else {
                        cssTextArr.push(strings.format(_CSS_MAP.contentIconPath, uri_1.default.revive(opts.contentIconPath).toString(true).replace(/'/g, '%27')));
                    }
                }
        ...
        DecorationCSSRules.prototype.getCSSTextForModelDecorationGlyphMarginClassName = function (opts) {
            ...
            if (typeof opts.gutterIconPath !== 'undefined') {
                if (typeof opts.gutterIconPath === 'string') {
                    cssTextArr.push(strings.format(_CSS_MAP.gutterIconPath, uri_1.default.file(opts.gutterIconPath).toString()));
                }
                else {
                    cssTextArr.push(strings.format(_CSS_MAP.gutterIconPath, uri_1.default.revive(opts.gutterIconPath).toString(true).replace(/'/g, '%27')));
                }
