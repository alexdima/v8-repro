define(["require", "exports", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/viewModel/viewModel", "vs/editor/common/view/viewEvents", "vs/editor/common/model/textModel", "vs/base/common/color"], function (require, exports, position_1, range_1, prefixSumComputer_1, viewModel_1, viewEvents, textModel_1, color_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var SplitLinesCollection = /** @class */ (function () {
        ...
        SplitLinesCollection.prototype.getDecorationsInRange = function (range, ownerId, filterOutValidation) {
            ...
            if (modelEnd.lineNumber - modelStart.lineNumber <= range.endLineNumber - range.startLineNumber) {
                ...
                return this.model.getDecorationsInRange(new range_1.Range(modelStart.lineNumber, modelStart.column, modelEnd.lineNumber, modelEnd.column), ownerId, filterOutValidation);
            }
            var result = [];
            var modelStartLineIndex = modelStart.lineNumber - 1;
            var modelEndLineIndex = modelEnd.lineNumber - 1;
