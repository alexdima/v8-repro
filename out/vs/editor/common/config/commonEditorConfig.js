...
define(["require", "exports", "vs/nls", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/objects", "vs/base/common/platform", "vs/platform/configuration/common/configurationRegistry", "vs/platform/registry/common/platform", "vs/editor/common/config/fontInfo", "vs/editor/common/config/editorZoom", "vs/editor/common/config/editorOptions"], function (require, exports, nls, event_1, lifecycle_1, objects, platform, configurationRegistry_1, platform_1, fontInfo_1, editorZoom_1, editorOptions) {
    ...
    var CommonEditorConfiguration = /** @class */ (function (_super) {
        ...
        CommonEditorConfiguration.prototype._computeInternalOptions = function () {
            ...
            var bareFontInfo = fontInfo_1.BareFontInfo.createFromRawSettings(this._rawOptions, partialEnv.zoomLevel);
            var env = {
