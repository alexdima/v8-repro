...
define(["require", "exports", "vs/nls", "vs/base/common/platform", "vs/base/common/scrollable", "vs/editor/common/model/wordHelper"], function (require, exports, nls, platform, scrollable_1, wordHelper_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var EditorOptionsValidator = /** @class */ (function () {
        ...
        EditorOptionsValidator._sanitizeContribInfo = function (opts, defaults) {
            ...
            return {
                ...
                acceptSuggestionOnEnter: typeof opts.acceptSuggestionOnEnter === 'string' ? _stringSet(opts.acceptSuggestionOnEnter, defaults.acceptSuggestionOnEnter, ['on', 'smart', 'off']) : opts.acceptSuggestionOnEnter ? 'on' : 'off',
