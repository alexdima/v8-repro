...
define(["require", "exports", "vs/base/common/errors", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/winjs.base", "vs/platform/instantiation/common/serviceCollection", "vs/platform/contextkey/common/contextkey", "vs/editor/common/controller/cursor", "vs/editor/common/controller/cursorCommon", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/editorCommon", "vs/editor/common/viewModel/viewModelImpl", "vs/base/common/hash", "vs/editor/common/editorContextKeys", "vs/editor/common/model/textModel", "vs/editor/common/modes", "vs/base/common/network", "vs/editor/common/model"], function (require, exports, errors_1, event_1, lifecycle_1, winjs_base_1, serviceCollection_1, contextkey_1, cursor_1, cursorCommon_1, position_1, range_1, selection_1, editorCommon, viewModelImpl_1, hash_1, editorContextKeys_1, textModel_1, modes, network_1, model_1) {
    ...
    var CommonCodeEditor = /** @class */ (function (_super) {
        ...
        CommonCodeEditor.prototype.trigger = function (source, handlerId, payload) {
            ...
            if (action) {
                winjs_base_1.TPromise.as(action.run()).then(null, errors_1.onUnexpectedError);
                return;
            }
            if (!this.cursor) {
                return;
