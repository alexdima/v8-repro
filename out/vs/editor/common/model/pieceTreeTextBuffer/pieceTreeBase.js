define(["require", "exports", "vs/editor/common/core/position", "vs/editor/common/model/pieceTreeTextBuffer/rbTreeBase"], function (require, exports, position_1, rbTreeBase_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var PieceTreeBase = /** @class */ (function () {
        ...
        PieceTreeBase.prototype.shrinkNode = function (node, start, end) {
            ...
            rbTreeBase_1.updateTreeMetadata(this, node, newLength - oldLength, newLFCnt - oldLFCnt);
