define(["require", "exports", "vs/base/common/strings", "vs/editor/common/model", "vs/editor/common/model/chunksTextBuffer/bufferPiece", "vs/editor/common/model/chunksTextBuffer/chunksTextBuffer"], function (require, exports, strings, model_1, bufferPiece_1, chunksTextBuffer_1) {
    /*---------------------------------------------------------------------------------------------
        ...
        TextBufferFactory.prototype.create = function (defaultEOL) {
            ...
            if ((eol === '\r\n' && (this._cr > 0 || this._lf > 0))
                ...
                for (var i = 0, len = pieces.length; i < len; i++) {
                    pieces[i] = bufferPiece_1.BufferPiece.normalizeEOL(pieces[i], eol);
                }
            }
            return new chunksTextBuffer_1.ChunksTextBuffer(pieces, this._averageChunkSize, this._BOM, eol, this._containsRTL, this._isBasicASCII);
        };
    ...
    exports.TextBufferFactory = TextBufferFactory;
    var ChunksTextBufferBuilder = /** @class */ (function () {
        ...
        ChunksTextBufferBuilder.prototype._acceptChunk2 = function (chunk) {
            var lineStarts = bufferPiece_1.createLineStarts(this._tmpLineStarts, chunk);
            this._rawPieces.push(new bufferPiece_1.BufferPiece(chunk, lineStarts.lineStarts));
        ...
        ChunksTextBufferBuilder.prototype._finish = function () {
            ...
            if (this._hasPreviousChar) {
                ...
                var tmp = new bufferPiece_1.BufferPiece(String.fromCharCode(this._previousChar));
                var newLastPiece = bufferPiece_1.BufferPiece.join(lastPiece, tmp);
    ...
    exports.ChunksTextBufferBuilder = ChunksTextBufferBuilder;
});
