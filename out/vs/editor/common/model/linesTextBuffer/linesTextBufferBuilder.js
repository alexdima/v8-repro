define(["require", "exports", "vs/base/common/strings", "vs/editor/common/model/linesTextBuffer/textSource", "vs/editor/common/model/linesTextBuffer/linesTextBuffer"], function (require, exports, strings, textSource_1, linesTextBuffer_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var TextBufferFactory = /** @class */ (function () {
        ...
        TextBufferFactory.prototype.create = function (defaultEOL) {
            var textSource = textSource_1.TextSource.fromRawTextSource(this.rawTextSource, defaultEOL);
            return new linesTextBuffer_1.LinesTextBuffer(textSource);
        };
    ...
    exports.LinesTextBufferBuilder = LinesTextBufferBuilder;
});
