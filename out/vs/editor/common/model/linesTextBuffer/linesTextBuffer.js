define(["require", "exports", "vs/editor/common/core/range", "vs/editor/common/core/position", "vs/base/common/strings", "vs/base/common/arrays", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/model"], function (require, exports, range_1, position_1, strings, arrays, prefixSumComputer_1, model_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var LinesTextBuffer = /** @class */ (function () {
        ...
        LinesTextBuffer.prototype.getRangeAt = function (offset, length) {
            ...
            return new range_1.Range(startResult.index + 1, startColumn, endResult.index + 1, endColumn);
        };
    ...
    exports.LinesTextBuffer = LinesTextBuffer;
});
