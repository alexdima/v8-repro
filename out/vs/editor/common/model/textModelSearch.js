define(["require", "exports", "vs/base/common/strings", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model", "vs/editor/common/controller/wordCharacterClassifier"], function (require, exports, strings, position_1, range_1, model_1, wordCharacterClassifier_1) {
    /*---------------------------------------------------------------------------------------------
            ...
            if (searchData.regex.multiline) {
                if (searchData.regex.source === '\\n') {
                    ...
                    for (var lineNumber = 1, lineCount = model.getLineCount(); lineNumber < lineCount; lineNumber++) {
                        var range = new range_1.Range(lineNumber, model.getLineMaxColumn(lineNumber), lineNumber + 1, 1);
                        if (captureMatches) {
                            result[resultLen++] = new model_1.FindMatch(range, null);
                        }
                        else {
                            result[resultLen++] = new model_1.FindMatch(range, ['\n']);
                        }
