 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/winjs.base", "vs/editor/common/modes/modesRegistry", "vs/editor/standalone/browser/standaloneServices", "vs/editor/common/modes", "vs/editor/common/modes/languageConfiguration", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/base/common/async", "vs/editor/standalone/common/monarch/monarchCompile", "vs/editor/standalone/common/monarch/monarchLexer", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/common/core/token"], function (require, exports, winjs_base_1, modesRegistry_1, standaloneServices_1, modes, languageConfiguration_1, position_1, range_1, async_1, monarchCompile_1, monarchLexer_1, languageConfigurationRegistry_1, token_1) {
    'use strict';
    ...
    function setTokensProvider(languageId, provider) {
        ...
        var adapter = new TokenizationSupport2Adapter(standaloneServices_1.StaticServices.standaloneThemeService.get(), languageIdentifier, provider);
    ...
    function setMonarchTokensProvider(languageId, languageDef) {
        ...
        var adapter = monarchLexer_1.createTokenizationSupport(standaloneServices_1.StaticServices.modeService.get(), standaloneServices_1.StaticServices.standaloneThemeService.get(), languageId, lexer);
        return modes.TokenizationRegistry.register(languageId, adapter);
    }
    ...
    var SuggestAdapter = /** @class */ (function () {
        ...
        SuggestAdapter.prototype.provideCompletionItems = function (model, position, context, token) {
            ...
            return async_1.toThenable(result).then(function (value) {
                var result = {
                    suggestions: []
                };
