...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/common/keyCodes", "vs/base/common/async", "vs/editor/common/model", "vs/editor/common/editorContextKeys", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/controller/cursorEvents", "vs/editor/common/controller/cursorMoveCommands", "vs/editor/common/modes", "vs/editor/contrib/find/findController", "vs/editor/common/model/textModel", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService"], function (require, exports, nls, lifecycle_1, keyCodes_1, async_1, model_1, editorContextKeys_1, editorExtensions_1, range_1, selection_1, cursorEvents_1, cursorMoveCommands_1, modes_1, findController_1, textModel_1, colorRegistry_1, themeService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var InsertCursorAbove = /** @class */ (function (_super) {
        ...
        InsertCursorAbove.prototype.run = function (accessor, editor, args) {
            ...
            cursors.setStates(args.source, cursorEvents_1.CursorChangeReason.Explicit, cursorMoveCommands_1.CursorMoveCommands.addCursorUp(context, cursors.getAll()));
    ...
    var InsertCursorBelow = /** @class */ (function (_super) {
        ...
        InsertCursorBelow.prototype.run = function (accessor, editor, args) {
            ...
            context.model.pushStackElement();
            cursors.setStates(args.source, cursorEvents_1.CursorChangeReason.Explicit, cursorMoveCommands_1.CursorMoveCommands.addCursorDown(context, cursors.getAll()));
