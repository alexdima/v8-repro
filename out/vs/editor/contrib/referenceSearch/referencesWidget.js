...
define(["require", "exports", "vs/nls", "vs/base/common/errors", "vs/base/common/labels", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/network", "vs/base/common/strings", "vs/base/common/winjs.base", "vs/base/common/color", "vs/base/browser/builder", "vs/base/browser/dom", "vs/base/browser/ui/sash/sash", "vs/base/browser/ui/countBadge/countBadge", "vs/base/browser/ui/iconLabel/iconLabel", "vs/platform/instantiation/common/instantiation", "vs/platform/workspace/common/workspace", "vs/editor/common/core/range", "vs/editor/common/editorCommon", "vs/editor/common/model/textModel", "vs/editor/browser/widget/embeddedCodeEditorWidget", "./peekViewWidget", "./referencesModel", "vs/editor/common/services/resolverService", "vs/platform/theme/common/colorRegistry", "vs/platform/theme/common/themeService", "vs/platform/theme/common/styler", "vs/platform/environment/common/environment", "vs/base/common/uri", "vs/editor/common/model", "vs/platform/list/browser/listService", "vs/platform/contextkey/common/contextkey", "vs/base/parts/tree/browser/treeDefaults", "vs/css!./media/referencesWidget"], function (require, exports, nls, errors_1, labels_1, event_1, lifecycle_1, network_1, strings, winjs_base_1, color_1, builder_1, dom, sash_1, countBadge_1, iconLabel_1, instantiation_1, workspace_1, range_1, editorCommon, textModel_1, embeddedCodeEditorWidget_1, peekViewWidget_1, referencesModel_1, resolverService_1, colorRegistry_1, themeService_1, styler_1, environment_1, uri_1, model_1, listService_1, contextkey_1, treeDefaults_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var Controller = /** @class */ (function (_super) {
        ...
        function Controller() {
            ...
            _this._onDidOpenToSide = new event_1.Emitter();
    ...
    var FileReferencesTemplate = /** @class */ (function () {
        function FileReferencesTemplate(container, _contextService, _environmentService, themeService) {
            ...
            this.badge = new countBadge_1.CountBadge(builder_1.$('.count').appendTo(parent).getHTMLElement());
    ...
    var ReferenceWidget = /** @class */ (function (_super) {
        ...
        ReferenceWidget.prototype._fillBody = function (containerElement) {
            ...
            container.div({ 'class': 'preview inline' }, function (div) {
                ...
                _this._previewNotAvailableMessage = textModel_1.TextModel.createFromString(nls.localize('missingPreviewMessage', "no preview available"));
            });
            // sash
            ...
            container.div({ 'class': 'ref-tree inline' }, function (div) {
                var controller = _this._instantiationService.createInstance(Controller, { clickBehavior: treeDefaults_1.ClickBehavior.ON_MOUSE_UP /* our controller already deals with this */ });
                ...
                _this._tree = _this._instantiationService.createInstance(listService_1.WorkbenchTree, div.getHTMLElement(), config, options);
                _this._callOnDispose.push(styler_1.attachListStyler(_this._tree, _this._themeService));
                exports.ctxReferenceWidgetSearchTreeFocused.bindTo(_this._tree.contextKeyService);
