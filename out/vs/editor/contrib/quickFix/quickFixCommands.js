...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/platform/commands/common/commands", "vs/platform/contextview/browser/contextView", "vs/platform/contextkey/common/contextkey", "vs/platform/keybinding/common/keybinding", "vs/platform/instantiation/common/instantiation", "vs/platform/markers/common/markers", "vs/editor/common/editorContextKeys", "vs/editor/browser/editorExtensions", "./quickFixWidget", "./lightBulbWidget", "./quickFixModel", "./codeActionTrigger", "vs/base/common/winjs.base", "vs/editor/browser/services/bulkEdit", "vs/platform/files/common/files", "vs/editor/common/services/resolverService"], function (require, exports, nls, lifecycle_1, commands_1, contextView_1, contextkey_1, keybinding_1, instantiation_1, markers_1, editorContextKeys_1, editorExtensions_1, quickFixWidget_1, lightBulbWidget_1, quickFixModel_1, codeActionTrigger_1, winjs_base_1, bulkEdit_1, files_1, resolverService_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var QuickFixController = /** @class */ (function () {
        function QuickFixController(editor, markerService, contextKeyService, _commandService, contextMenuService, _keybindingService, _textModelService, _fileService) {
            ...
            this._quickFixContextMenu = new quickFixWidget_1.QuickFixContextMenu(editor, contextMenuService, function (action) { return _this._onApplyCodeAction(action); });
        ...
        QuickFixController.prototype._onQuickFixEvent = function (e) {
            ...
            if (e && e.trigger.kind) {
                ...
                e.fixes.then(function (fixes) {
                    if (e.trigger.autoApply === codeActionTrigger_1.CodeActionAutoApply.First || (e.trigger.autoApply === codeActionTrigger_1.CodeActionAutoApply.IfSingle && fixes.length === 1)) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, bulkEdit_1.BulkEdit.perform(action.edit.edits, this._textModelService, this._fileService, this._editor)];
                        case 1:
                            _b.sent();
                            _b.label = 2;
                        case 2:
        ...
        QuickFixController = __decorate([
            ...
            __param(7, instantiation_1.optional(files_1.IFileService))
        ], QuickFixController);
    ...
    var CodeActionCommandArgs = /** @class */ (function () {
        ...
        CodeActionCommandArgs.fromUser = function (arg) {
            if (!arg || typeof arg !== 'object') {
                return new CodeActionCommandArgs(codeActionTrigger_1.CodeActionKind.Empty, codeActionTrigger_1.CodeActionAutoApply.IfSingle);
            }
        ...
        CodeActionCommandArgs.getApplyFromUser = function (arg) {
            switch (typeof arg.apply === 'string' ? arg.apply.toLowerCase() : '') {
                case 'first':
                    return codeActionTrigger_1.CodeActionAutoApply.First;
                case 'never':
                    return codeActionTrigger_1.CodeActionAutoApply.Never;
                case 'ifsingle':
                default:
                    return codeActionTrigger_1.CodeActionAutoApply.IfSingle;
            }
        };
        CodeActionCommandArgs.getKindFromUser = function (arg) {
            return typeof arg.kind === 'string'
                ? new codeActionTrigger_1.CodeActionKind(arg.kind)
                : codeActionTrigger_1.CodeActionKind.Empty;
        };
    ...
    var RefactorAction = /** @class */ (function (_super) {
        ...
        RefactorAction.prototype.run = function (accessor, editor) {
            var controller = QuickFixController.get(editor);
            if (controller) {
                controller.triggerCodeActionFromEditorSelection(codeActionTrigger_1.CodeActionKind.Refactor, codeActionTrigger_1.CodeActionAutoApply.Never);
            }
        };
    ...
    editorExtensions_1.registerEditorContribution(QuickFixController);
    editorExtensions_1.registerEditorAction(QuickFixAction);
    editorExtensions_1.registerEditorAction(RefactorAction);
    editorExtensions_1.registerEditorCommand(new CodeActionCommand());
});
