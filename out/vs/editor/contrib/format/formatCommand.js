define(["require", "exports", "vs/base/common/strings", "vs/editor/common/core/range", "vs/editor/common/core/editOperation"], function (require, exports, strings, range_1, editOperation_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var EditOperationsCommand = /** @class */ (function () {
        ...
        EditOperationsCommand.execute = function (editor, edits, asCommand) {
            ...
            editor.pushUndoStop();
            if (!asCommand) {
                editor.executeEdits('formatEditsCommand', cmd._edits.map(function (edit) { return editOperation_1.EditOperation.replace(range_1.Range.lift(edit.range), edit.text); }));
            }
            else {
