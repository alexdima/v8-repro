define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/model/textModel", "vs/editor/contrib/format/formatCommand", "vs/editor/test/browser/testCommand"], function (require, exports, assert, range_1, selection_1, textModel_1, formatCommand_1, testCommand_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('FormatCommand', function () {
        function testFormatCommand(lines, selection, edits, expectedLines, expectedSelection) {
            testCommand_1.testCommand(lines, null, selection, function (sel) { return new formatCommand_1.EditOperationsCommand(edits, sel); }, expectedLines, expectedSelection);
        }
        test('no-op', function () {
            testFormatCommand([
                'some text',
