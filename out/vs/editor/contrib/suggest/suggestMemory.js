...
define(["require", "exports", "vs/base/common/map", "vs/platform/storage/common/storage", "vs/base/common/async"], function (require, exports, map_1, storage_1, async_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var LRUMemory = /** @class */ (function (_super) {
        ...
        function LRUMemory() {
            ...
            _this._cache = new map_1.LRUCache(300, .66);
            _this._seq = 0;
            return _this;
        }
    ...
    var SuggestMemories = /** @class */ (function () {
        function SuggestMemories(mode, _storageService) {
            ...
            this._persistSoon = new async_1.RunOnceScheduler(function () { return _this._flush(); }, 3000);
            this.setMode(mode);
        }
        SuggestMemories.prototype.setMode = function (mode) {
            ...
            try {
                var raw = this._storageService.get(this._storagePrefix + "/" + this._mode, storage_1.StorageScope.WORKSPACE);
        ...
        SuggestMemories.prototype._flush = function () {
            ...
            this._storageService.store(this._storagePrefix + "/" + this._mode, raw, storage_1.StorageScope.WORKSPACE);
        };
    ...
    exports.SuggestMemories = SuggestMemories;
});
