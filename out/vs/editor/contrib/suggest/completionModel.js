 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/filters", "vs/base/common/lifecycle"], function (require, exports, filters_1, lifecycle_1) {
    'use strict';
    ...
    var CompletionModel = /** @class */ (function () {
        ...
        CompletionModel.prototype._createCachedState = function () {
            ...
            var scoreFn = source.length > 2000 ? filters_1.fuzzyScore : filters_1.fuzzyScoreGracefulAggressive;
            for (var i = 0; i < source.length; i++) {
                ...
                if (wordLen === 0) {
                    ...
                    item.score = match[0];
                    item.matches = filters_1.skipScore(word, suggestion.label)[1];
                }
                else {
