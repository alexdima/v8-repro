define(["require", "exports", "vs/base/common/errors", "vs/base/common/arrays", "vs/base/common/async", "vs/base/common/event", "vs/base/common/lifecycle", "vs/base/common/winjs.base", "vs/editor/common/modes", "vs/editor/common/core/position", "./suggest", "./completionModel", "vs/editor/common/controller/cursorEvents"], function (require, exports, errors_1, arrays_1, async_1, event_1, lifecycle_1, winjs_base_1, modes_1, position_1, suggest_1, completionModel_1, cursorEvents_1) {
    ...
    var SuggestModel = /** @class */ (function () {
        function SuggestModel(editor) {
            ...
            this._context = null;
            this._currentPosition = this._editor.getPosition() || new position_1.Position(1, 1);
            ...
            this._toDispose.push(modes_1.SuggestRegistry.onDidChange(function () {
                _this._updateTriggerCharacters();
        ...
        SuggestModel.prototype.dispose = function () {
            lifecycle_1.dispose([this._onDidCancel, this._onDidSuggest, this._onDidTrigger, this._triggerCharacterListener, this._triggerRefilter]);
        ...
        SuggestModel.prototype._updateTriggerCharacters = function () {
            ...
            for (var _i = 0, _a = modes_1.SuggestRegistry.all(this._editor.getModel()); _i < _a.length; _i++) {
                var support = _a[_i];
        ...
        SuggestModel.prototype._updateActiveSuggestSession = function () {
            if (this._state !== 0 /* Idle */) {
                if (!modes_1.SuggestRegistry.has(this._editor.getModel())) {
                    this.cancel();
                }
                else {
        ...
        SuggestModel.prototype._onCursorChange = function (e) {
            ...
            if (this._state === 0 /* Idle */) {
                ...
                if (this._editor.getConfiguration().contribInfo.quickSuggestions !== false
                    ...
                    this.cancel();
                    this._triggerAutoSuggestPromise = winjs_base_1.TPromise.timeout(this._quickSuggestDelay);
        ...
        SuggestModel.prototype.trigger = function (context, retrigger, onlyFrom, existingItems) {
            ...
            if (context.triggerCharacter) {
                suggestCtx = {
                    triggerKind: modes_1.SuggestTriggerKind.TriggerCharacter,
                    triggerCharacter: context.triggerCharacter
                };
            }
            else if (onlyFrom && onlyFrom.length) {
                suggestCtx = { triggerKind: modes_1.SuggestTriggerKind.TriggerForIncompleteCompletions };
            }
            else {
                suggestCtx = { triggerKind: modes_1.SuggestTriggerKind.Invoke };
            }
            this._requestPromise = suggest_1.provideSuggestionItems(model, this._editor.getPosition(), this._editor.getConfiguration().contribInfo.snippetSuggestions, onlyFrom, suggestCtx).then(function (items) {
                ...
                if (!arrays_1.isFalsyOrEmpty(existingItems)) {
                    var cmpFn = suggest_1.getSuggestionComparator(_this._editor.getConfiguration().contribInfo.snippetSuggestions);
