...
define(["require", "exports", "vs/base/common/color", "vs/base/common/hash", "vs/base/common/lifecycle", "vs/base/common/winjs.base", "vs/editor/browser/editorExtensions", "vs/editor/common/core/range", "vs/editor/common/modes", "vs/editor/browser/services/codeEditorService", "vs/editor/contrib/colorPicker/color", "vs/platform/configuration/common/configuration"], function (require, exports, color_1, hash_1, lifecycle_1, winjs_base_1, editorExtensions_1, range_1, modes_1, codeEditorService_1, color_2, configuration_1) {
    "use strict";
        ...
        ColorDetector.prototype.onModelChanged = function () {
            ...
            this._localToDispose.push(this._editor.onDidChangeModelContent(function (e) {
                if (!_this._timeoutPromise) {
                    _this._timeoutPromise = winjs_base_1.TPromise.timeout(ColorDetector.RECOMPUTE_TIME);
