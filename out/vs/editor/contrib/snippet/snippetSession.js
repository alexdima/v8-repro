 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/editor/common/model", "vs/editor/common/core/editOperation", "./snippetParser", "vs/editor/common/core/selection", "vs/editor/common/core/range", "vs/base/common/arrays", "vs/base/common/lifecycle", "./snippetVariables", "vs/editor/common/model/textModel", "vs/platform/clipboard/common/clipboardService", "vs/platform/instantiation/common/instantiation", "vs/css!./snippetSession"], function (require, exports, strings_1, model_1, editOperation_1, snippetParser_1, selection_1, range_1, arrays_1, lifecycle_1, snippetVariables_1, textModel_1, clipboardService_1, instantiation_1) {
    'use strict';
    ...
    var SnippetSession = /** @class */ (function () {
        ...
        SnippetSession.adjustWhitespace = function (model, position, template) {
            ...
            for (var i = 1; i < templateLines.length; i++) {
                var templateLeadingWhitespace = strings_1.getLeadingWhitespace(templateLines[i]);
        ...
        SnippetSession.createEditsAndSnippets = function (editor, template, overwriteBefore, overwriteAfter, enforceFinalTabstop) {
            ...
            for (var _i = 0, indexedSelections_1 = indexedSelections; _i < indexedSelections_1.length; _i++) {
                ...
                var snippet = new snippetParser_1.SnippetParser()
                    .parse(adjustedTemplate, true, enforceFinalTabstop)
                    .resolveVariables(new snippetVariables_1.CompositeSnippetVariableResolver([
