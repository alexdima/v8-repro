...
define(["require", "exports", "vs/nls", "vs/base/common/keyCodes", "vs/editor/contrib/linesOperations/sortLinesCommand", "vs/editor/common/core/editOperation", "vs/editor/common/commands/trimTrailingWhitespaceCommand", "vs/editor/common/editorContextKeys", "vs/editor/common/commands/replaceCommand", "vs/editor/common/core/range", "vs/editor/common/core/selection", "vs/editor/common/core/position", "vs/editor/browser/editorExtensions", "./copyLinesCommand", "./deleteLinesCommand", "./moveLinesCommand", "vs/editor/common/controller/cursorTypeOperations", "vs/editor/browser/controller/coreCommands"], function (require, exports, nls, keyCodes_1, sortLinesCommand_1, editOperation_1, trimTrailingWhitespaceCommand_1, editorContextKeys_1, replaceCommand_1, range_1, selection_1, position_1, editorExtensions_1, copyLinesCommand_1, deleteLinesCommand_1, moveLinesCommand_1, cursorTypeOperations_1, coreCommands_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var TrimTrailingWhitespaceAction = /** @class */ (function (_super) {
        ...
        TrimTrailingWhitespaceAction.prototype.run = function (accessor, editor, args) {
            ...
            var command = new trimTrailingWhitespaceCommand_1.TrimTrailingWhitespaceCommand(editor.getSelection(), cursors);
            editor.pushUndoStop();
