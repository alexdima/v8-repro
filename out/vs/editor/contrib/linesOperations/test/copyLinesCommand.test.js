define(["require", "exports", "vs/editor/common/core/selection", "vs/editor/contrib/linesOperations/copyLinesCommand", "vs/editor/test/browser/testCommand"], function (require, exports, selection_1, copyLinesCommand_1, testCommand_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function testCopyLinesDownCommand(lines, selection, expectedLines, expectedSelection) {
        testCommand_1.testCommand(lines, null, selection, function (sel) { return new copyLinesCommand_1.CopyLinesCommand(sel, true); }, expectedLines, expectedSelection);
    }
    function testCopyLinesUpCommand(lines, selection, expectedLines, expectedSelection) {
        testCommand_1.testCommand(lines, null, selection, function (sel) { return new copyLinesCommand_1.CopyLinesCommand(sel, false); }, expectedLines, expectedSelection);
    }
