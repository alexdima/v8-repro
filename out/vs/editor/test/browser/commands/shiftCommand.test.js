...
define(["require", "exports", "assert", "vs/editor/common/commands/shiftCommand", "vs/editor/common/core/selection", "vs/editor/common/core/range", "vs/editor/common/modes/languageConfiguration", "vs/editor/common/modes/languageConfigurationRegistry", "vs/editor/test/browser/testCommand", "vs/editor/test/common/editorTestUtils", "vs/editor/test/common/mocks/mockMode", "vs/editor/common/modes"], function (require, exports, assert, shiftCommand_1, selection_1, range_1, languageConfiguration_1, languageConfigurationRegistry_1, testCommand_1, editorTestUtils_1, mockMode_1, modes_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    var DocBlockCommentMode = /** @class */ (function (_super) {
    ...
    function testShiftCommand(lines, languageIdentifier, useTabStops, selection, expectedLines, expectedSelection) {
        testCommand_1.testCommand(lines, languageIdentifier, selection, function (sel) { return new shiftCommand_1.ShiftCommand(sel, {
            isUnshift: false,
            tabSize: 4,
            oneIndent: '\t',
