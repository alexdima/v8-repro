define(["require", "exports", "assert", "vs/editor/common/controller/cursorCommon"], function (require, exports, assert, cursorCommon_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('CursorMove', function () {
        test('nextTabStop', function () {
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(0, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(1, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(2, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(3, 4), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(4, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(5, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(6, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(7, 4), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(8, 4), 12);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(0, 2), 2);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(1, 2), 2);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(2, 2), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(3, 2), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(4, 2), 6);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(5, 2), 6);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(6, 2), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(7, 2), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(8, 2), 10);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(0, 1), 1);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(1, 1), 2);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(2, 1), 3);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(3, 1), 4);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(4, 1), 5);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(5, 1), 6);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(6, 1), 7);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(7, 1), 8);
            assert.equal(cursorCommon_1.CursorColumns.nextTabStop(8, 1), 9);
        });
        test('visibleColumnFromColumn', function () {
            function testVisibleColumnFromColumn(text, tabSize, column, expected) {
                assert.equal(cursorCommon_1.CursorColumns.visibleColumnFromColumn(text, column, tabSize), expected);
            }
        ...
        test('columnFromVisibleColumn', function () {
            function testColumnFromVisibleColumn(text, tabSize, visibleColumn, expected) {
                assert.equal(cursorCommon_1.CursorColumns.columnFromVisibleColumn(text, visibleColumn, tabSize), expected);
            }
