define(["require", "exports", "assert", "vs/editor/common/viewModel/prefixSumComputer", "vs/editor/common/core/uint"], function (require, exports, assert, prefixSumComputer_1, uint_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    suite('Editor ViewModel - PrefixSumComputer', function () {
        test('PrefixSumComputer', function () {
            var indexOfResult;
            var psc = new prefixSumComputer_1.PrefixSumComputer(uint_1.toUint32Array([1, 1, 2, 1, 3]));
