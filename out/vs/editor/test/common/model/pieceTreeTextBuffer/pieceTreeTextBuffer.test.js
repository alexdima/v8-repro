define(["require", "exports", "assert", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder", "vs/editor/common/model", "vs/editor/common/model/pieceTreeTextBuffer/rbTreeBase"], function (require, exports, assert, position_1, range_1, pieceTreeTextBufferBuilder_1, model_1, rbTreeBase_1) {
    /*---------------------------------------------------------------------------------------------
    ...
    function testLinesContent(str, pieceTable) {
        ...
        for (var i = 0; i < lines.length; i++) {
            ...
            assert.equal(trimLineFeed(pieceTable.getValueInRange(new range_1.Range(i + 1, 1, i + 1, lines[i].length + (i === lines.length - 1 ? 1 : 2)))), lines[i]);
        }
    }
    function testLineStarts(str, pieceTable) {
        ...
        for (var i = 0; i < lineStarts.length; i++) {
            assert.deepEqual(pieceTable.getPositionAt(lineStarts[i]), new position_1.Position(i + 1, 1));
        ...
        for (var i = 1; i < lineStarts.length; i++) {
            ...
            assert.equal(pieceTable.getOffsetAt(pos.lineNumber, pos.column), lineStarts[i] - 1);
        }
    }
    function createTextBuffer(val, normalizeEOL) {
        if (normalizeEOL === void 0) { normalizeEOL = true; }
        var bufferBuilder = new pieceTreeTextBufferBuilder_1.PieceTreeTextBufferBuilder();
        for (var i = 0; i < val.length; i++) {
            bufferBuilder.acceptChunk(val[i]);
        }
        var factory = bufferBuilder.finish(normalizeEOL);
        return factory.create(model_1.DefaultEndOfLine.LF).getPieceTree();
    }
    function assertTreeInvariants(T) {
        assert(rbTreeBase_1.SENTINEL.color === 0 /* Black */);
    ...
    function depth(n) {
        ...
        return (n.color === 0 /* Black */ ? 1 : 0) + depth(n.left);
    }
    function assertValidNode(n) {
        ...
        var r = n.right;
        if (n.color === 1 /* Red */) {
            assert(l.color === 0 /* Black */);
            assert(r.color === 0 /* Black */);
        }
    ...
    function assertValidTree(T) {
        ...
        assert(T.root.color === 0 /* Black */);
        assert(depth(T.root.left) === depth(T.root.right));
        assertValidNode(T.root);
    }
    //#endregion
    suite('inserts and deletes', function () {
        test('basic insert/delete', function () {
            ...
            assert.equal(pieceTable.getLinesRawContent(), 'This is a document with some text.This is some more text to insert at offset 34.');
            pieceTable.delete(42, 5);
            assert.equal(pieceTable.getLinesRawContent(), 'This is a document with some text.This is more text to insert at offset 34.');
            assertTreeInvariants(pieceTable);
        });
        test('more inserts', function () {
        ...
        test('random insert/delete \\r bug 1', function () {
            var str = 'a';
        ...
        test('random insert/delete \\r bug 2', function () {
            var str = 'a';
            var pieceTable = createTextBuffer(['a']);
            pieceTable.insert(1, '\naa\r');
        ...
        test('random insert/delete \\r bug 3', function () {
            var str = 'a';
            var pieceTable = createTextBuffer(['a']);
            pieceTable.insert(0, '\r\na\r');
        ...
        test('random insert/delete \\r bug 4s', function () {
            var str = 'a';
            var pieceTable = createTextBuffer(['a']);
            pieceTable.delete(0, 1);
            str = str.substring(0, 0) + str.substring(0 + 1);
        ...
        test('random insert/delete \\r bug 5', function () {
            var str = '';
            var pieceTable = createTextBuffer(['']);
            pieceTable.insert(0, '\n\n\n\r');
            str = str.substring(0, 0) + '\n\n\n\r' + str.substring(0);
    ...
    suite('prefix sum for line feed', function () {
        test('basic', function () {
            var pieceTable = createTextBuffer(['1\n2\n3\n4']);
            assert.equal(pieceTable.getLineCount(), 4);
            assert.deepEqual(pieceTable.getPositionAt(0), new position_1.Position(1, 1));
            assert.deepEqual(pieceTable.getPositionAt(1), new position_1.Position(1, 2));
            assert.deepEqual(pieceTable.getPositionAt(2), new position_1.Position(2, 1));
            assert.deepEqual(pieceTable.getPositionAt(3), new position_1.Position(2, 2));
            assert.deepEqual(pieceTable.getPositionAt(4), new position_1.Position(3, 1));
            assert.deepEqual(pieceTable.getPositionAt(5), new position_1.Position(3, 2));
            assert.deepEqual(pieceTable.getPositionAt(6), new position_1.Position(4, 1));
        ...
        test('append', function () {
            ...
            assert.deepEqual(pieceTable.getPositionAt(9), new position_1.Position(4, 4));
            assert.equal(pieceTable.getOffsetAt(1, 1), 0);
            assertTreeInvariants(pieceTable);
        });
        test('insert', function () {
            ...
            assert.equal(pieceTable.getLineCount(), 6);
            assert.deepEqual(pieceTable.getPositionAt(6), new position_1.Position(4, 1));
            assert.deepEqual(pieceTable.getPositionAt(7), new position_1.Position(4, 2));
            assert.deepEqual(pieceTable.getPositionAt(8), new position_1.Position(4, 3));
            assert.deepEqual(pieceTable.getPositionAt(9), new position_1.Position(4, 4));
            assert.deepEqual(pieceTable.getPositionAt(12), new position_1.Position(6, 1));
            assert.deepEqual(pieceTable.getPositionAt(13), new position_1.Position(6, 2));
            assert.deepEqual(pieceTable.getPositionAt(14), new position_1.Position(6, 3));
            assert.equal(pieceTable.getOffsetAt(4, 1), 6);
        ...
        test('delete', function () {
            ...
            assert.deepEqual(pieceTable.getPositionAt(7), new position_1.Position(4, 2));
            assert.deepEqual(pieceTable.getPositionAt(8), new position_1.Position(4, 3));
            assert.deepEqual(pieceTable.getPositionAt(9), new position_1.Position(5, 1));
            assert.deepEqual(pieceTable.getPositionAt(11), new position_1.Position(6, 1));
            assert.deepEqual(pieceTable.getPositionAt(12), new position_1.Position(6, 2));
            assert.deepEqual(pieceTable.getPositionAt(13), new position_1.Position(6, 3));
            assert.equal(pieceTable.getOffsetAt(4, 1), 6);
            assert.equal(pieceTable.getOffsetAt(4, 2), 7);
            assert.equal(pieceTable.getOffsetAt(4, 3), 8);
        ...
        test('insert random bug 1: prefixSumComputer.removeValues(start, cnt) cnt is 1 based.', function () {
            var str = '';
            var pieceTable = createTextBuffer(['']);
        ...
        test('insert random bug 2: prefixSumComputer initialize does not do deep copy of UInt32Array.', function () {
            var str = '';
            var pieceTable = createTextBuffer(['']);
        ...
        test('delete random bug 1: I forgot to update the lineFeedCnt when deletion is on one single piece.', function () {
            var pieceTable = createTextBuffer(['']);
        ...
        test('delete random bug rb tree 1', function () {
            var str = '';
        ...
        test('delete random bug rb tree 2', function () {
            var str = '';
            var pieceTable = createTextBuffer([str]);
            pieceTable.insert(0, 'YXXZ\n\nYY\n');
            str = str.substring(0, 0) + 'YXXZ\n\nYY\n' + str.substring(0);
        ...
        test('delete random bug rb tree 3', function () {
            var str = '';
            var pieceTable = createTextBuffer([str]);
            pieceTable.insert(0, 'YXXZ\n\nYY\n');
            str = str.substring(0, 0) + 'YXXZ\n\nYY\n' + str.substring(0);
    ...
    suite('offset 2 position', function () {
        test('random tests bug 1', function () {
            var str = '';
            var pieceTable = createTextBuffer(['']);
    ...
    suite('get text in range', function () {
        test('getContentInRange', function () {
            var pieceTable = createTextBuffer(['a\nb\nc\nde']);
            pieceTable.insert(8, 'fh\ni\njk');
            pieceTable.delete(7, 2);
            // 'a\nb\nc\ndh\ni\njk'
            assert.equal(pieceTable.getValueInRange(new range_1.Range(1, 1, 1, 3)), 'a\n');
            assert.equal(pieceTable.getValueInRange(new range_1.Range(2, 1, 2, 3)), 'b\n');
            assert.equal(pieceTable.getValueInRange(new range_1.Range(3, 1, 3, 3)), 'c\n');
            assert.equal(pieceTable.getValueInRange(new range_1.Range(4, 1, 4, 4)), 'dh\n');
            assert.equal(pieceTable.getValueInRange(new range_1.Range(5, 1, 5, 3)), 'i\n');
            assert.equal(pieceTable.getValueInRange(new range_1.Range(6, 1, 6, 3)), 'jk');
            assertTreeInvariants(pieceTable);
        });
        test('random test value in range', function () {
            var str = '';
            var pieceTable = createTextBuffer([str]);
        ...
        test('random test value in range exception', function () {
            var str = '';
            var pieceTable = createTextBuffer([str]);
        ...
        test('random tests bug 2', function () {
            var str = '';
            var pieceTable = createTextBuffer(['']);
        ...
        test('get line content', function () {
            var pieceTable = createTextBuffer(['1']);
        ...
        test('get line content basic', function () {
            var pieceTable = createTextBuffer(['1\n2\n3\n4']);
            assert.equal(pieceTable.getLineRawContent(1), '1\n');
        ...
        test('get line content after inserts/deletes', function () {
            var pieceTable = createTextBuffer(['a\nb\nc\nde']);
            pieceTable.insert(8, 'fh\ni\njk');
            pieceTable.delete(7, 2);
            // 'a\nb\nc\ndh\ni\njk'
    ...
    suite('CRLF', function () {
        test('delete CR in CRLF 1', function () {
            var pieceTable = createTextBuffer([''], false);
            pieceTable.insert(0, 'a\r\nb');
            pieceTable.delete(0, 2);
            assert.equal(pieceTable.getLineCount(), 2);
            assertTreeInvariants(pieceTable);
        });
        test('delete CR in CRLF 2', function () {
            var pieceTable = createTextBuffer([''], false);
            pieceTable.insert(0, 'a\r\nb');
    ...
    suite('centralized lineStarts with CRLF', function () {
        test('delete CR in CRLF 1', function () {
            var pieceTable = createTextBuffer(['a\r\nb'], false);
            pieceTable.delete(2, 2);
            assert.equal(pieceTable.getLineCount(), 2);
        ...
        test('random bug 8', function () {
            var str = '\r\r\n\n';
            var pieceTable = createTextBuffer(['\r\r\n\n'], false);
            pieceTable.insert(4, '\r\n\n\r');
            str = str.substring(0, 4) + '\r\n\n\r' + str.substring(4);
            pieceTable.insert(7, '\n\r\r\r');
            str = str.substring(0, 7) + '\n\r\r\r' + str.substring(7);
        ...
        test('random bug 9', function () {
            var str = 'qneW';
            var pieceTable = createTextBuffer(['qneW'], false);
            pieceTable.insert(0, 'YhIl');
            str = str.substring(0, 0) + 'YhIl' + str.substring(0);
            pieceTable.insert(0, 'qdsm');
            str = str.substring(0, 0) + 'qdsm' + str.substring(0);
        ...
        test('random chunk bug 1', function () {
            var pieceTable = createTextBuffer(['\n\r\r\n\n\n\r\n\r'], false);
            var str = '\n\r\r\n\n\n\r\n\r';
            pieceTable.delete(0, 2);
            str = str.substring(0, 0) + str.substring(0 + 2);
        ...
        test('random chunk bug 2', function () {
            var pieceTable = createTextBuffer([
                '\n\r\n\n\n\r\n\r\n\r\r\n\n\n\r\r\n\r\n'
            ], false);
            var str = '\n\r\n\n\n\r\n\r\n\r\r\n\n\n\r\r\n\r\n';
        ...
        test('random chunk bug 3', function () {
            var pieceTable = createTextBuffer(['\r\n\n\n\n\n\n\r\n'], false);
            var str = '\r\n\n\n\n\n\n\r\n';
            pieceTable.insert(4, '\n\n\r\n\r\r\n\n\r');
            str = str.substring(0, 4) + '\n\n\r\n\r\r\n\n\r' + str.substring(4);
        ...
        test('random chunk bug 4', function () {
            var pieceTable = createTextBuffer(['\n\r\n\r'], false);
            var str = '\n\r\n\r';
            pieceTable.insert(4, '\n\n\r\n');
            str = str.substring(0, 4) + '\n\n\r\n' + str.substring(4);
    ...
    suite('random is unsupervised', function () {
        test('random insert delete', function () {
            this.timeout(500000);
            var str = '';
            var pieceTable = createTextBuffer([str], false);
            for (var i = 0; i < 1000; i++) {
                if (Math.random() < 0.6) {
                    ...
                    var length_1 = Math.min(str.length - pos, Math.floor(Math.random() * 10));
                    pieceTable.delete(pos, length_1);
                    str = str.substring(0, pos) + str.substring(pos + length_1);
                }
            }
            assert.equal(pieceTable.getLinesRawContent(), str);
            testLineStarts(str, pieceTable);
        ...
        test('random chunks', function () {
            ...
            var pieceTable = createTextBuffer(chunks, false);
            var str = chunks.join('');
            for (var i = 0; i < 1000; i++) {
                if (Math.random() < 0.6) {
                    // insert
                    ...
                    // delete
                    var pos = randomInt(str.length);
                    var length_2 = Math.min(str.length - pos, Math.floor(Math.random() * 10));
                    pieceTable.delete(pos, length_2);
                    str = str.substring(0, pos) + str.substring(pos + length_2);
                }
            }
            assert.equal(pieceTable.getLinesRawContent(), str);
            testLineStarts(str, pieceTable);
        ...
        test('random chunks 2', function () {
            ...
            for (var i = 0; i < 50; i++) {
                if (Math.random() < 0.6) {
                    ...
                    // delete
                    var pos = randomInt(str.length);
                    var length_3 = Math.min(str.length - pos, Math.floor(Math.random() * 10));
                    pieceTable.delete(pos, length_3);
                    str = str.substring(0, pos) + str.substring(pos + length_3);
                }
                testLinesContent(str, pieceTable);
            }
            assert.equal(pieceTable.getLinesRawContent(), str);
    ...
    suite('buffer api', function () {
        ...
        test('equal 2, empty buffer', function () {
            var a = createTextBuffer(['']);
            var b = createTextBuffer(['']);
            assert(a.equal(b));
        });
        test('equal 3, empty buffer', function () {
            var a = createTextBuffer(['a']);
            var b = createTextBuffer(['']);
            assert(!a.equal(b));
        });
    });
    suite('search offset cache', function () {
        test('render white space exception', function () {
        ...
        test('Line breaks replacement is not necessary when EOL is normalized', function () {
        ...
        test('Line breaks replacement is not necessary when EOL is normalized 2', function () {
            var pieceTable = createTextBuffer(['abc\n']);
            var str = 'abc\n';
        ...
        test('Line breaks replacement is not necessary when EOL is normalized 3', function () {
            var pieceTable = createTextBuffer(['abc\n']);
            var str = 'abc\n';
        ...
        test('Line breaks replacement is not necessary when EOL is normalized 4', function () {
            var pieceTable = createTextBuffer(['abc\n']);
            var str = 'abc\n';
            pieceTable.insert(3, 'def\nabc');
