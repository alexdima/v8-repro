 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/range", "vs/editor/common/model/linesTextBuffer/linesTextBuffer"], function (require, exports, assert, range_1, linesTextBuffer_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('LinesTextBuffer._getInverseEdits', function () {
        ...
        function assertInverseEdits(ops, expected) {
            var actual = linesTextBuffer_1.LinesTextBuffer._getInverseEditRanges(ops);
    ...
    suite('LinesTextBuffer._toSingleEditOperation', function () {
        ...
        function testToSingleEditOperation(original, edits, expected) {
            var textBuffer = new linesTextBuffer_1.LinesTextBuffer({
                BOM: '',
                EOL: '\n',
                containsRTL: false,
                isBasicASCII: true,
            ...
            var actual = textBuffer._toSingleEditOperation(edits);
            assert.deepEqual(actual, expected);
        }
