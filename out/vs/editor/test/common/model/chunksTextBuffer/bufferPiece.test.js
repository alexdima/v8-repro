 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/model/chunksTextBuffer/bufferPiece"], function (require, exports, assert, bufferPiece_1) {
    'use strict';
    Object.defineProperty(exports, "__esModule", { value: true });
    suite('BufferPiece', function () {
        test('findLineStartBeforeOffset', function () {
            var piece = new bufferPiece_1.BufferPiece([
                'Line1\r\n',
                'l2\n',
                'another\r',
                'and\r\n',
