define(["require", "exports", "assert", "vs/editor/common/viewLayout/linesLayout"], function (require, exports, assert, linesLayout_1) {
    ...
    suite('Editor ViewLayout - LinesLayout', function () {
        test('LinesLayout 1', function () {
            // Start off with 10 lines
            var linesLayout = new linesLayout_1.LinesLayout(10, 10);
        ...
        test('LinesLayout 2', function () {
            // Start off with 10 lines and one whitespace after line 2, of height 5
            var linesLayout = new linesLayout_1.LinesLayout(10, 1);
        ...
        test('LinesLayout getLineNumberAtOrAfterVerticalOffset', function () {
            var linesLayout = new linesLayout_1.LinesLayout(10, 1);
        ...
        test('LinesLayout getCenteredLineInViewport', function () {
            var linesLayout = new linesLayout_1.LinesLayout(10, 1);
            linesLayout.insertWhitespace(6, 0, 10);
            // 10 lines
            // whitespace: - a(6,10)
        ...
        test('LinesLayout getLinesViewportData 1', function () {
            var linesLayout = new linesLayout_1.LinesLayout(10, 10);
        ...
        test('LinesLayout getLinesViewportData 2 & getWhitespaceViewportData', function () {
            var linesLayout = new linesLayout_1.LinesLayout(10, 10);
        ...
        test('LinesLayout getWhitespaceAtVerticalOffset', function () {
            var linesLayout = new linesLayout_1.LinesLayout(10, 10);
            var a = linesLayout.insertWhitespace(6, 0, 100);
            var b = linesLayout.insertWhitespace(7, 0, 50);
