...
const product = require('./out/product.json');
const package = require('./out/package.json');
...
function getBundleContents() {
	return getModules().map(function (module) {
...
function getFakeEnvironmentalVariables() {
	return `
	var MonacoSnapshotPlatform = 'darwin';
	var MonacoSnapshotArch = 'x64';
